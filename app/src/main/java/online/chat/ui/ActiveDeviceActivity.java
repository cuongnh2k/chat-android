...
import online.chat.databinding.ActivityActiveDeviceBinding;

public class ActiveDeviceActivity extends AppCompatActivity {
    ActivityActiveDeviceBinding mBinding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBinding = ActivityActiveDeviceBinding.inflate(getLayoutInflater());
